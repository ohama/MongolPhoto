# Requirements Archive: v1.2 몽골 여행 사진

**Archived:** 2026-07-14
**Status:** ✅ SHIPPED

이 문서는 v1.2의 아카이브된 요구사항 명세입니다. 현재 요구사항은 다음 마일스톤에서 새로 정의됩니다(`/gsd:new-milestone`). PROJECT.md의 Validated 절이 마일스톤 간 누적 기록을 유지합니다.
...
**Shipped:** 12 / 12 v1.2 requirements (100%)
- STRUCT (2): 여행 파트 최상단 삽입 + 3-트랙 확장 — Phase 11
- GEAR (3): 개요·범위 / 카메라 설정 / 렌즈 활용·추천 — Phase 12
- SHOOT (3): 구도·빛·타이밍 / 초광각·준망원 실전 / 사람·현지 예절 — Phase 12
- TSITE (2): 명소 5곳 가이드 / 지형 특화 팁 — Phase 13
- TREF (2): 갤러리(CC 임베드) / 튜토리얼 링크 + 최종 검증 — Phase 14

**Adjusted (구현 중 조정):**
- TSITE-02: 욜링암 야생 문구를 연구 기반(수염수리)과 실재(야크 접근 계곡 방목)에 맞춰 "수염수리·야크·아이벡스(모두 기회성)"로 조정.
- (Phase 12 완료 후) 상황별 카메라 세팅(시간대·날씨) 치트 페이지(11-travel/situational-settings.md)를 추가 — GEAR/SHOOT 범위의 실무 보강.

**Dropped:** 없음

---
*Archived: 2026-07-14 as part of v1.2 milestone completion*
