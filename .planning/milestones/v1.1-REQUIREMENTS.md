# Requirements Archive: v1.1 드론 사진

**Archived:** 2026-07-14
**Status:** ✅ SHIPPED

이 문서는 v1.1의 아카이브된 요구사항 명세입니다. 현재 요구사항은 다음 마일스톤에서 새로 정의됩니다(`/gsd:new-milestone`). PROJECT.md의 Validated 절이 마일스톤 간 누적 기록을 유지합니다.
...
**Shipped:** 13 / 13 v1.1 requirements (100%)
- BOOK (2): 책 확장 + SUMMARY 재편 — Phase 7
- DRONE (6): 개요/규제/조작·설정/구도·비행/환경/후보정 — Phase 8
- DSITE (2): 명소 5곳 항공 가이드 + 명소별 주의 — Phase 9
- DREF (3): 규제·허가/튜토리얼/갤러리 링크 — Phase 10

**Adjusted (구현 중 조정):**
- DRONE-01·02(개요·규제 요약): 초판은 개요 페이지에 규제 요약을 배치했으나, 이후 개요를 "드론 사진의 매력" 중심으로 개편하고 규제 요약을 참고자료(DREF-01, 08-references/drone-mongolia-regulations.md) 한 페이지로 일원화. 개요에는 짧은 포인터만 유지.
- DSITE-01: 명소 페이지에 실제 현지 사진(CC0/CC BY/CC BY-SA) 추가 — 초기 계획의 placeholder 주석을 실제 예시 사진으로 대체.

**Dropped:** 없음

---
*Archived: 2026-07-14 as part of v1.1 milestone completion*
