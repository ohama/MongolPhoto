# Requirements Archive: v1.0 몽골 은하수 촬영기 (초판)

**Archived:** 2026-07-13
**Status:** ✅ SHIPPED

v1.0의 요구사항 명세 아카이브입니다. 현재 요구사항은 `.planning/REQUIREMENTS.md`(다음 마일스톤용) 참조.
...
**Shipped:** 37 / 37 v1 요구사항 전부 완료 (PUB·GEAR·FUND·PRAC·HOME·FIELD·EDIT·SITE·BONUS·REF).

**Adjusted (마일스톤 중 변경):**
- 장비: "구매 가이드" 범위 제외 → 추천만 (사용자 요청). 구체 모델은 부록 REF-05로 이동.
- 2~5부 재구성(2026-07-09): 개인 연습 일지·여행 결과(PRAC-02~05·MONG·POST)를 일반 가이드(HOME·FIELD·EDIT·SITE)로 대체. 날짜 게이트 폐기.
- REF-05(카메라·렌즈 추천 목록) Phase 1에서 앞당겨 완료.

**Dropped:** 없음 — 대체된 개인화 요구사항은 일반 가이드로 승계.

**추가 산출물(요구사항 외):** 매력적인 소개 페이지 + CC0/무료 라이선스 예시 사진 9장, 참고 자료 5종(촬영 기법·소프트웨어·연습용 RAW·몽골 천체사진 링크·여행 실무), 전체 통독 교열 2회 + 초보자 눈높이 점검.

---
*Archived: 2026-07-13 as part of v1.0 milestone completion*
