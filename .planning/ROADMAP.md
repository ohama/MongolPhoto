...
Plans:
- [x] 30-01-PLAN.md — 드론 영상 2종 콘텐츠(차강소브라·몽고말떼, SB-01) — 이미지 전사 샷 리스트·설정·동선·편집·BGM + 정직 캡션
- [x] 30-02-PLAN.md — 통합 2종(홍고린엘스·욜링암, SB-02) — 세 카메라 계획 + 4부 field-day 상향 링크
- [x] 30-03-PLAN.md — 통합 2종(바가가즈링촐로·바양작, SB-02) + 4부 field-day.md 통합 4종 역링크
