...
Plans:
- [ ] 09-01-PLAN.md — 명소별 항공 파트 허브(overview: GPS 표·이론 링크 재사용 + 국립공원 미확인 캐비어트) + 차강소브라가(흰 절벽·층리)
- [ ] 09-02-PLAN.md — 홍고린엘스(사구·바람·모래) + 욜링암(협곡벽·GPS·RTH), 두 국립공원 미확인 캐비어트 사이트
- [ ] 09-03-PLAN.md — 바양작(붉은 사암·화석지) + 바가가즈링 촐로(화강암 기암·GPS 다중경로·최북단 저온)
