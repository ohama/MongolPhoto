...
- ✅ **v1.5 현장 워크플로** — Phases 24-28 (로드맵 완주, complete-milestone 대기)
...
- [x] **Phase 25: 여행 전 준비 (PREP)** — 3장비 통합 패킹 + 촬영 계획·앱 오프라인
- [x] **Phase 26: 하루 현장 운용 (FIELD)** — 하루 타임라인 + 세 카메라 오케스트레이션
- [x] **Phase 27: 데이터·전원 운용 (DATA)** — 카드 전략·현장 백업 + 멀티데이 오프그리드 전원
- [x] **Phase 28: 귀국 후 정리 (POST) + 최종 게이트** — 3-2-1 백업·선별·편집 순서 허브 + 책 전체 빌드·링크 검증
...
Plans:
- [x] 25-01-PLAN.md — preparation.md 실 콘텐츠(PREP-01 통합 패킹 + PREP-02 촬영 계획·오프라인 앱·지도, 부록/기존 파트 허브 링크 승계)
...
Plans:
- [x] 26-01-PLAN.md — 하루 현장 운용 1페이지(field-day.md): FIELD-01 하루 타임라인 예시 시간표(도착→낮→드론→황혼→밤→백업) + FIELD-02 세 카메라 오케스트레이션(우선순위·전환·셔터 찬스, R7 낮/밤 겸용) + 빌드·링크 게이트
...
Plans:
- [x] 27-01: 카드 전략·현장 RAW 백업(DATA-01) + 멀티데이 오프그리드 전원(DATA-02)
...
Plans:
- [x] 28-01: 귀국 후 정리 — 3-2-1 백업·아카이브(POST-01) + 선별·트랙별 편집 순서 허브(POST-02)
- [x] 28-02: 책 전체 최종 `mdbook build src` 그린 + 내부 링크 전수 스캔 dead 0 리포트 [wave 2, depends_on 28-01]
...
| 25. 여행 전 준비 | v1.5 | 1/1 | Complete | 2026-07-20 |
| 26. 하루 현장 운용 | v1.5 | 1/1 | Complete | 2026-07-20 |
| 27. 데이터·전원 운용 | v1.5 | 1/1 | Complete | 2026-07-20 |
| 28. 귀국 후 정리 + 게이트 | v1.5 | 2/2 | Complete | 2026-07-21 |
