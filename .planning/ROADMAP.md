...
- [ ] **Phase 24: 현장 워크플로 파트 신설 + 스텁** — 새 4부 + 개요 랜딩 + 전 챕터 스텁, create-missing=false 빌드 그린
...
Plans:
- [ ] 24-01-PLAN.md — `4-workflow/` 신설(옵션 a · 평면 5페이지: 개요 랜딩 + 준비·하루·데이터전원·귀국후 스텁 4) + SUMMARY 4부 섹션 + introduction 카드 그룹 + README 항목 + 빌드 그린·링크 dead 0 게이트
...
| 24. 파트 신설 + 스텁 | v1.5 | 0/1 | Not started | - |
