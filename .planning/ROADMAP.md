...
**Goal**: 독자가 book 사이트에서 장비 추천과 기초 촬영법을 확인하고, 연습 1차를 준비/기록할 수 있는 상태가 된다. 이 프로젝트에서 가장 시간 압박이 큰 phase — 7/17 서해안 실전 전에 반드시 완료되어야 함 (장비 주문 리드타임 포함).
...
**Success Criteria** (what must be TRUE):
  ...
  3. 독자가 장비 챕터(카메라·렌즈·액세서리·앱·체크리스트)를 보고 실제 구매 결정을 내릴 수 있다 (사용자의 실제 카메라 기종에 맞춘 세팅 포함).
...
Plans:
- [ ] 01-01: TBD (세부 계획은 /gsd:plan-phase 1 실행 시 산출)
