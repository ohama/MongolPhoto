...
- [ ] **Phase 1: mdBook 뼈대 + 장비 + 기초 촬영법** - 긴급(7/17 이전 완료 필수): book 골격, 장비 추천, 기초 촬영법, 연습 로그 템플릿
...
Plans:
- [ ] 01-01-PLAN.md — mdBook 뼈대: book.toml, 한국어 폰트(Noto Sans KR)+keep-all, 전체 SUMMARY 스켈레톤+스텁 트리, 이미지 최적화 스크립트 (PUB-01, PUB-03)
- [ ] 01-02-PLAN.md — 장비 챕터: 마운트별 카메라·렌즈 추천, 크롭계수 계산법, 액세서리·앱, 준비물 체크리스트 (GEAR-01~06)
- [ ] 01-03-PLAN.md — 기초 촬영법 A: M모드 노출 3요소, 크롭 500룰 계산, 별 수동 초점 (FUND-01, FUND-02, FUND-03)
- [ ] 01-04-PLAN.md — 기초 촬영법 B + 템플릿: RAW·화밸, 은하수 찾기·타이밍, 현장 워크플로, 연습 로그 템플릿 (FUND-04, FUND-05, FUND-06, PRAC-01)
- [ ] 01-05-PLAN.md — GitHub Pages 배포: CI 빌드→docs/ 커밋 패턴, Pages 설정, 라이브 사이트 검증 (PUB-02)
...
|-------|----------------|--------|-----------|
| 1. mdBook 뼈대 + 장비 + 기초 촬영법 | 0/TBD | Not started | - |
