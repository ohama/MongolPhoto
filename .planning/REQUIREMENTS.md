...
- [x] **TSITE-01**: 개요 + 명소 5곳 여행 사진 가이드 (지형별 피사체·구도·타이밍), 04-mongolia GPS 표 링크 재사용(좌표 재기입 없음)
- [x] **TSITE-02**: 명소별 지형 특화 여행 팁 — 차강소브라가(층리·황혼), 바양작(붉은 절벽·화석지 예절), 홍고린엘스(사구·낙타), 욜링암(협곡·얼음·수염수리·야크·아이벡스), 바가가즈링 촐로(화강암 기암). 야생/유목민은 "보이면/기회성" 정직 표기.
