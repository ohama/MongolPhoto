...
**책 내 관련 챕터**: [노출의 기본: M모드 3요소](../src/02-fundamentals/exposure-basics.md)
...
## 셔터속도 한계: 500 룰 / NPF 룰 (크롭 보정)

**책 내 관련 챕터**: [500 / NPF 룰 — 크롭센서 셔터속도 계산](../src/02-fundamentals/500-npf-rule.md)

- [NPF: The New Rule for Shooting the Sharpest Stars in the Sky](https://www.nationalparksatnight.com/blog/2019/4/13/new-rule-for-shooting-the-sharpest-stars-in-the-sky) — National Parks at Night(저자 Gabriel Biderman) · 무료 글. 500 룰의 한계와 NPF 룰이 필요한 이유를 실제 렌즈·바디로 비교 테스트한 결과와 함께 설명합니다.
...
**책 내 관련 챕터**: [별에 초점 맞추기](../src/02-fundamentals/focusing.md)

- [Focusing at Night: A Tutorial](https://www.lonelyspeck.com/focusing-at-night/) — Lonely Speck · 무료 글. 라이브뷰로 밝은 별에 확대·수동 초점을 맞추는 단계별 절차와 초점 고정(테이프) 요령을 다룹니다.
- [Finding infinity: Seven ways to focus on the night stars](https://photofocus.com/photography/finding-infinity-seven-ways-to-focus-on-the-night-stars/) — Photofocus(저자 Ken Lee) · 무료 글. 라이브뷰 확대 외에 원거리 불빛·달·회절 필터 등 7가지 대안 초점법을 비교합니다.

## RAW · 화이트밸런스

**책 내 관련 챕터**: [RAW와 화이트밸런스](../src/02-fundamentals/raw-and-wb.md)

- [Setting Your White Balance for Astrophotography](https://astrobackyard.com/white-balance-astrophotography/) — AstroBackyard · 무료 글. RAW로 찍으면 화이트밸런스를 후보정에서 재조정할 수 있다는 전제와, 그럼에도 현장에서 어떤 값을 기준으로 잡으면 좋은지 설명합니다.
- [How to Choose the Right White Balance for Night Skies](https://www.nationalparksatnight.com/blog/2017/6/14/how-to-choose-the-right-white-balance-for-night-skies) — National Parks at Night(저자 Matt Hill) · 무료 글. 켈빈(K) 값별로 밤하늘 색감이 어떻게 달라지는지 실제 예시 사진과 함께 설명합니다.

## 은하수 찾기·계획 (달·계절·방향·Bortle·날씨) + 앱

**책 내 관련 챕터**: [은하수 찾기와 타이밍](../src/02-fundamentals/finding-the-milkyway.md), [필수 액세서리 & 앱](../src/01-gear/accessories.md)
...
- [Find Your Night Sky Brightness on the Bortle Scale](https://astrobackyard.com/the-bortle-scale/) — AstroBackyard · 무료 글. Bortle 1~9 각 등급에서 실제로 무엇이 보이는지(은하수 육안 관측 여부 등)를 표로 정리해 설명합니다.
...
**책 내 관련 챕터**: [현장 촬영 워크플로](../src/02-fundamentals/field-workflow.md)
...
**책 내 관련 챕터**: [RAW 현상 기본](../src/05-postprocessing/raw-develop.md)

- [darktable](https://www.darktable.org/) — 공식 사이트 · 공식 문서·다운로드(무료, 오픈소스). 이 책이 기본으로 추천하는 RAW 현상 소프트웨어의 공식 홈페이지입니다.
...
**책 내 관련 챕터**: [스태킹으로 노이즈 줄이기](../src/05-postprocessing/stacking.md)

- [Sequator](https://sites.google.com/view/sequator/) — 공식 사이트(제작자 Yi-Ruei Wu) · 공식 다운로드(무료, Windows 전용). 이 책이 추천하는 무료 스태킹 도구의 공식 다운로드·설명 페이지입니다.
- [Starry Landscape Stacker](https://sites.google.com/site/starrylandscapestacker/home) — 공식 사이트(제작자 Ralph D. Hill) · 공식 다운로드(유료, 약 $40, Mac 전용). 하늘/땅을 브러시로 나눠 마스킹하는 방식과 무료 체험판 안내가 있습니다.
- [How to Use Sequator to Stack Astrophotos and Reduce Noise](https://improvephotography.com/50102/stack-astrophotos-reduce-noise-sequator/) — Improve Photography · 무료 글. Sequator의 Base Image·Sky Region·Freeze Ground 등 실제 조작 단계를 설명합니다.

## 은하수 강조 보정

**책 내 관련 챕터**: [은하수 강조 보정](../src/05-postprocessing/enhance-milkyway.md)
...
**책 내 관련 챕터**: [은하수 파노라마 촬영·병합](../src/06-bonus/panorama.md)
...
**책 내 관련 챕터**: [스타트레일(별궤적) 촬영·합성](../src/06-bonus/star-trails.md)

- [StarStaX](https://markus-enzweiler.de/software/starstax/) — 공식 사이트(제작자 Markus Enzweiler) · 공식 다운로드(무료, 상업적 이용 포함 무료 명시, Win/Mac). 이 책이 추천하는 별궤적 합성 도구의 공식 다운로드 페이지입니다.
- [Star Trails Photography – Full Guide + Step by Step Tutorial](https://capturetheatlas.com/star-trails-photography-guide/) — Capture the Atlas · 무료 글. 촬영 설정(ISO 800~1600, 30~60초)부터 StarStaX·Sequator를 이용한 후처리까지 다룹니다.

## 보너스 — 타임랩스 (ffmpeg / LRTimelapse)

**책 내 관련 챕터**: [밤하늘 타임랩스](../src/06-bonus/timelapse.md)

- [FFmpeg](https://ffmpeg.org/) — 공식 사이트 · 공식 문서·다운로드(무료, 오픈소스). 이미지 시퀀스를 영상으로 조립할 때 쓰는 커맨드라인 도구의 공식 홈페이지입니다.
- [LRTimelapse](https://lrtimelapse.com/) — 공식 사이트 · 공식 문서·다운로드(유료). 디플리커(Visual Deflicker)와 Lightroom 연동 워크플로를 제공하는 공식 페이지입니다.
- [How to Shoot a Stunning Night Sky Time-Lapse Video (6 Steps)](https://expertphotography.com/night-sky-time-lapse) — ExpertPhotography · 무료 글. 인터벌 간격 설정부터 촬영 시간 계산, 초점·구도 유지까지 실전 단계를 다룹니다.

## 장비 개념 (밝은 광각 렌즈 · 삼각대 · 인터벌 타이머 · 코마수차)

**책 내 관련 챕터**: [카메라와 렌즈 고르기](../src/01-gear/camera-lens.md), [카메라 · 렌즈 추천 목록](../src/07-appendix/camera-lens-picks.md)

- [Getting the Best Star Points for Astro Landscapes: How to Test Lenses for Coma](https://www.nationalparksatnight.com/blog/2019/12/14/getting-the-best-star-points-for-astro-landscapes-how-to-test-lenses-for-coma) — National Parks at Night(저자 Matt Hill) · 무료 글. 코마수차가 무엇이고 왜 화면 가장자리 별이 "새 날개"처럼 번지는지, 직접 렌즈를 테스트하는 방법까지 설명합니다.
- [The best lenses for astrophotography](https://www.digitalcameraworld.com/buying-guides/best-lenses-for-astrophotography) — Digital Camera World(저자 Matthew Richards) · 무료 글. 마운트별로 밝은 광각 렌즈를 비교한 구매 가이드입니다.
...
- Adobe Lightroom 공식 페이지 (타임아웃)

**라이선스·정확성 재확인**
- 소프트웨어 공식 페이지(darktable, Sequator, Starry Landscape Stacker, Hugin, PTGui, StarStaX, ffmpeg, LRTimelapse)는 버전이 계속 올라가므로, 실제로 설치하기 전 다운로드 페이지의 최신 버전·시스템 요구사항을 다시 확인하세요.
- Microsoft ICE는 공식 페이지에 "이 프로젝트는 지원이 종료되었습니다(retired)"라고 명시되어 있습니다 — 새 환경(최신 Windows)에서 정상 동작을 보장하지 않으니, 파노라마 병합은 Hugin이나 PTGui를 우선 고려하는 편이 낫습니다.
- 이 문서의 글 링크는 모두 각 사이트의 저작물입니다. 책 본문에 문장·표를 그대로 옮기지 말고, 개념을 이해하는 참고용으로만 사용하세요.
