...
> 🔰 **초보자는 이렇게.** 목록을 건너뛰지 말고 **[Canon R7 카메라 설정 · 렌즈 선택](camera-settings.md)부터** 위 순서 그대로 읽으세요. 촬영 6개 → 명소별 → 보정 순서가 실제 촬영 흐름과 같아서, 이대로 따라오면 준비부터 완성까지 한 번에 이어집니다. 명소별·보정 파트는 촬영편을 먼저 익힌 뒤에 보세요.
