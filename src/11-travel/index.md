...
몽골 고비는 은하수가 뜨는 밤에만, 혹은 드론이 뜨는 순간에만 아름다운 곳이 아닙니다. 하루 종일 — 차창 밖으로 스쳐 가는 초원, 게르에서 마주치는 사람들, 사구를 오르며 흘리는 땀, 저녁 식사 자리의 웃음 — 여행 그 자체가 사진이 됩니다. 1부는 그 낮의 시간을, **Canon R7 같은 미러리스 카메라**로 담는 법을 다룹니다.
...
7. [코스 명소별 여행 사진 가이드](../12-travel-sites/overview.md) — 실제 몽골 코스의 명소별로 배운 것을 적용합니다.
