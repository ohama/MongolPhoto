...
- **전경이 극적입니다.** 붉게 타는 절벽(바양작), 거대한 모래언덕(홍고린엘스), 협곡과 화강암 바위지대 — 은하수 아래에 놓을 전경 소재가 풍부합니다. 명소별 촬영법은 [6부 · 은하수 명소별 촬영 가이드](04-mongolia/overview.md)에서 다룹니다.
...
이 세 단계만 거쳐도 "그냥 어두운 하늘"이 "은하수 사진"으로 바뀝니다. 전체 과정은 [7부 · 은하수 후보정](05-postprocessing/raw-develop.md)에서 단계별로 따라 할 수 있습니다.
...
1. **[1부 · 여행 사진](11-travel/index.md)** — Canon R7로 주간·황혼 여행 사진을 찍습니다(카메라 설정·구도·빛·현장/사람 + 코스 명소별 여행 가이드).
2. **[2부 · 여행 사진 보정](13-editing/index.md)** — 찍은 여행 사진을 Lightroom 등으로 비파괴 보정합니다.
3. **[3부 · 드론 사진](09-drone/index.md)** — DJI Mini 5 Pro로 주간·황혼 항공 사진을 찍습니다(개요·규제 요약·조작/설정·구도·비행·환경·후보정 + 명소별 항공 가이드).
4. **[4부 · 준비하기](01-gear/index.md)** — 은하수용 장비와 기초 촬영법을 익힙니다.
5. **[5부 · 가기 전 연습](03-practice/home-camera-controls.md)** — 집과 근교에서 미리 손에 익힙니다.
6. **[6부 · 은하수 명소별 촬영 가이드](04-mongolia/overview.md)** — 고비 현지에서 무엇을·어디서·어떻게 찍을지 판단합니다.
7. **[7부 · 은하수 후보정](05-postprocessing/raw-develop.md)** — 찍은 사진을 완성합니다.
8. **보너스 기법**·**부록**(치트시트·체크리스트·용어사전)·**참고 자료**(여행/드론/은하수 공통)로 마무리합니다.
