...
몽골 고비 사막은 여행자의 두 발로 걷는 낮, 드론으로 내려다보는 하늘, 카메라로 올려다보는 밤 — 세 얼굴을 가진 촬영지입니다. 낮에는 붉은 절벽과 거대한 모래언덕, 협곡을 두 눈으로 마주하며 그 스케일을 드론으로도 담고, 해가 지고 불빛이 사라진 밤에는 눈으로도 은하수의 거대한 띠가 하늘을 가로지르는 광경을 만나게 됩니다. 이 책은 그 세 장면을 모두 당신이 직접 찍을 수 있도록 안내합니다.
...
- **[1부 · 여행 사진](11-travel/index.md)** — **Canon R7** 같은 미러리스로 담는 낮의 여행. 눈을 뜨고 있는 모든 시간에 찍는, 가장 자주 쓰는 사진입니다. 카메라 설정·구도·빛·현장/사람, 그리고 **Lightroom Classic 보정**까지.
- **[2부 · 드론 사진·영상](09-drone/index.md)** — **DJI Mini 5 Pro** 같은 소형 드론으로 담는 하늘의 시점. "그곳이 이렇게 생겼다"를 보여 주는 항공 사진과, 움직임으로 스케일을 전하는 **드론 영상**, 그리고 **CapCut 편집**까지.
- **[3부 · 천체사진 (은하수)](astro-overview.md)** — **트래킹 장비 없이** 카메라 한 대·삼각대만으로 담는 밤하늘. 준비부터 촬영, **스태킹·강조 후보정**까지.
...
*(사진을 추가할 때는 웹용으로 리사이즈(최대 2000px·EXIF 제거)해 `src/images/intro/`에 넣고, 위 자리를 `![캡션](images/intro/파일명.jpg)` 형식으로 바꾸면 됩니다.)*

## 이 책을 읽는 법

관심 있는 파트부터 골라 읽어도 되고, 순서대로 따라와도 됩니다.

1. **[1부 · 여행 사진](11-travel/index.md)** — Canon R7로 주간·황혼 여행 사진을 찍고(카메라 설정·구도·빛·현장/사람 + 코스 명소별), 이어서 **[여행 사진 보정](13-editing/index.md)**(Lightroom Classic)으로 완성합니다.
2. **[2부 · 드론 사진·영상](09-drone/index.md)** — DJI Mini 5 Pro로 주간·황혼 항공 사진을 찍고(조작/설정·구도·비행·환경 + 명소별), 사진 후보정과 **드론 영상 촬영·CapCut 편집**까지 다룹니다. 드론 규제·참고 자료도 이 부에 있습니다.
3. **[3부 · 천체사진 (은하수)](astro-overview.md)** — 트래킹 없이 은하수를 찍기 위한 장비·기초 촬영법·가기 전 연습·명소별 가이드·후보정을 보너스 기법·참고 자료와 함께 익힙니다.
4. **[부록](07-appendix/camera-lens-picks.md)** — 카메라·렌즈 추천·치트시트·체크리스트·앱/SW·용어사전.

준비되셨다면, [1부 · 여행 사진](11-travel/index.md)부터 시작하세요.
