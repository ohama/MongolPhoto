...
*트래킹 장비 없이, 카메라 한 대와 삼각대만으로 — 고비 사막의 밤하늘을 담는 법.*

도시에서는 밤하늘에 별이 몇 개 없습니다. 그러나 불빛이 사라진 곳으로 나가면, 눈으로도 은하수의 거대한 띠가 하늘을 가로지르는 광경을 만나게 됩니다. 그 장면을 처음 카메라에 담아 집에 돌아와 화면을 확대하는 순간 — 맨눈으로는 보이지 않던 수천 개의 별과 [은하수 코어](07-appendix/glossary.md)의 붉은빛·청보라빛 구조가 드러날 때의 감동은, 한 번 겪으면 잊기 어렵습니다.
...
이 세 단계만 거쳐도 "그냥 어두운 하늘"이 "은하수 사진"으로 바뀝니다. 전체 과정은 [4부 · 후보정](05-postprocessing/raw-develop.md)에서 단계별로 따라 할 수 있습니다.
...
1. **[1부 · 준비하기](01-gear/index.md)** — 장비와 기초 촬영법을 익힙니다.
2. **[2부 · 가기 전 연습](03-practice/home-camera-controls.md)** — 집과 근교에서 미리 손에 익힙니다.
3. **[3부 · 몽골 여행지별 촬영 가이드](04-mongolia/overview.md)** — 고비 현지에서 무엇을·어디서·어떻게 찍을지 판단합니다.
4. **[4부 · 후보정](05-postprocessing/raw-develop.md)** — 찍은 사진을 완성합니다.
