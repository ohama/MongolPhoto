...
**수록 기준**: 이 목록의 링크는 WebSearch로 후보를 찾은 뒤 WebFetch(일부는 curl로 다운로드 링크의 HTTP 상태까지) 직접 확인해, 실제로 열리고 다운로드가 가능한 것만 실었습니다. 403/402/타임아웃 등으로 확인하지 못한 후보는 싣지 않고 마지막 "참고 / 미검증" 절에 따로 정리했습니다.
