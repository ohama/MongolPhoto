...
**촬영으로 예방하기.** 이런 극단적 명암 차는 편집으로 메우기보다 촬영에서 줄이는 편이 낫습니다. 노출을 정확히 잡는 법은 [카메라 설정](../11-travel/camera-settings.md)과 [Av 모드·Auto ISO·최소 셔터속도](../11-travel/av-mode-auto-iso.md)에서, 편집을 염두에 둔 촬영법(하이라이트 보호·브라케팅 등)은 [촬영 시 고려사항](shoot-for-edit.md)에서 다룹니다.
...
**촬영으로 예방하기.** 역광은 노출 결정이 특히 까다롭습니다. 측광과 노출 보정은 [카메라 설정](../11-travel/camera-settings.md), 자동 노출을 다루는 법은 [Av 모드·Auto ISO·최소 셔터속도](../11-travel/av-mode-auto-iso.md)를 참고하세요.
...
**촬영으로 예방하기.** 날린 하늘은 애초에 촬영에서 막는 것이 최선입니다. **브라케팅(같은 장면을 노출을 달리해 여러 장 찍기) + HDR 병합**, **ETTR(노출을 오른쪽으로 — 하이라이트가 날지 않는 선에서 최대한 밝게 찍어 그림자 노이즈를 줄이는 기법)**, 또는 **그라디언트 ND 필터**로 하늘을 미리 잡을 수 있습니다. 자세한 촬영 대비는 [촬영 시 고려사항](shoot-for-edit.md)과 [카메라 설정](../11-travel/camera-settings.md)을 참고하세요.
