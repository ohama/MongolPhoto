...
7. [가기 전 연습 (드론)](practice/index.md) — 규제 확인·기본 비행·촬영 동작을 출발 전에 미리 익히는 연습 코스입니다.

**드론 영상 촬영**

8. [드론 영상 촬영](3-video/index.md) — 영상 설정(프레임레이트·180도 셔터·ND·컬러 프로파일)과 시네마틱 움직임 샷.

**CapCut 영상 편집**

9. [CapCut 영상 편집](4-capcut/index.md) — 편집 워크플로(컷·속도·색보정·음악·내보내기)와 대표 고비 클립 예제.
