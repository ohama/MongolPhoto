...
- **최북단 = 새벽 저온**: 4곳 중 가장 북쪽이라 새벽·아침 촬영 시 다른 명소보다 기온이 낮을 수 있습니다. 저온이 배터리 용량을 떨어뜨리는 물리적 원리와 예비 배터리를 보온하고 차가운 배터리로는 이륙하지 않는 등 구체적인 대응은 [고비 사막 드론 환경 주의](../09-drone/gobi-environment.md)와 [야외 준비와 현장 워크플로](../03-practice/field-prep-and-hazards.md)에서 이미 다뤘으니 그대로 따르세요.
